...
/**
 * Implementación del controlador para gestionar las feature flags. Proporciona endpoints para
 * crear, obtener todas y obtener una feature flag por su ID. Utiliza FeatureService para la lógica
 * de negocio.
 *
 * <p>Anotación - {@link RestController}: Indica que esta clase es un controlador REST. - {@link
 * RequiredArgsConstructor}: Genera un constructor con los campos finales. - {@link RequestMapping}:
 * Define la ruta base para los endpoints del controlador.
 */
@RestController
