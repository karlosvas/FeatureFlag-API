 ...
 * creating, retrieving, updating, and deleting feature flags. It also supports dynamic
 * feature toggling for specific clients and environments, making it suitable for production
 * feature rollouts and A/B testing scenarios.</p>
 * 
 * <p>The controller implements role-based access control with the following permissions:</p>
 * <ul>
 *   <li><strong>ADMIN:</strong> Full access to all operations including deletion</li>
 *   <li><strong>USER:</strong> Access to create, retrieve, and check feature flags</li>
 *   <li><strong>Public:</strong> Access to feature toggle operations</li>
 * </ul>
 * 
 * <p>Key features include:</p>
 * <ul>
 *   <li>CRUD operations for feature flags</li>
 *   <li>Paginated feature listing with filtering capabilities</li>
 *   <li>Dynamic feature toggling per client/environment</li>
 *   <li>Feature activation status checking</li>
