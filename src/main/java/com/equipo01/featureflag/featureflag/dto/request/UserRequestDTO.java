...
/**
 * DTO que representa la solicitud de creación de un nuevo usuario. Incluye los datos necesarios
 * para crear un usuario en el sistema.
 *
 * <p>Anotaciones utilizadas: - {@link Getter} Genera los métodos get automáticamente.
 *
 * <p>Atributos - username: Nombre de usuario para login. - email: Email del usuario. - password:
