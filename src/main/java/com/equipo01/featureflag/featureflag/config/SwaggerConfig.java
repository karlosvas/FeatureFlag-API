...
/**
 * Swagger/OpenAPI configuration class. This class configures automatic API documentation using
 * Swagger.
 */
@Configuration
public class SwaggerConfig {
  /**
   * Configures the general documentation of the API using OpenAPI. Also configures the JWT (Bearer
   * Token) security scheme that will be used to access protected endpoints.
   *
