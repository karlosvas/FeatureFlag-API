...
/**
 * Repository for managing features in the database. Extends JpaRepository to provide CRUD methods
 * and custom queries. Features are uniquely identified by a UUID.
 *
