...
public class FeatureControllerImpTest {
    ...
    void testGetFeature() throws Exception {
        FeatureResponseDto responseDto = FeatureResponseDto.builder()
                .id(featureId)
                .name("New Feature")
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .get(featuresEndpoint + "/{featureId}", featureId.toString()))
    ...
    void testCreateFeature() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.description").value("This is a newly created feature"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.enabledByDefault").value(true));
    }
    ...
    void testCreateFeature_throwsExceptionInvalidBody() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders
                ...
                .andReturn();
        assertAll(
                () -> assertTrue(result.getResponse().getContentAsString().contains("Feature name is required")),
                () -> assertTrue(result.getResponse().getContentAsString().contains("Feature description is required")),
    ...
    void testGetFeatures() throws Exception {
        GetFeatureResponseDto getFeatureResponseDto = GetFeatureResponseDto.builder()
        ...
        when(featureService.getFeatures(anyString(), any(), anyInt(), anyInt())).thenReturn(getFeatureResponseDto);
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.features[0].description").value("Description 1"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.links.first.href")
                        .value("?name=Feature 1&enabled=true&page=0&size=10"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.links.last.href")
                        .value("?name=Feature 1&enabled=true&page=0&size=10"));
    }
    ...
    void testGetFeatures_throwsExceptionInvalidPageAndSize() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders
                ...
                .andReturn();
        assertAll(
                () -> assertTrue(result.getResponse().getContentAsString().contains("Page must be at least 0")),
                () -> assertTrue(result.getResponse().getContentAsString().contains("Size must be at least 1"))
